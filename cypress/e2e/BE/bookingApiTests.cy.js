...
import { baseUrlApi } from "../../globalVariables";
...
describe("RESTful Booker API Tests", () => {
  ...
  it("Returning of a successful ping response", () => {
  ...
  it("Creation of a new booking", () => {
    ...
    cy.request("POST", `${baseUrlApi}/booking`, bookingData).should(
      (response) => {
  ...
  it("Deletion of an existing booking", () => {
    cy.request({
      method: "DELETE",
      url: `${baseUrlApi}/booking/${bookingId}`,
      headers: {
